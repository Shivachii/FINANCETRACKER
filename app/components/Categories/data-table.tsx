...
import DeleteCategory from "./DeleteCategories/DeleteCategories";
// import UpdateCategories from "./UpdateCategories/UpdateCategories";

interface DataTableProps<TData extends { name: string }, TValue> {
...
export function DataTable<TData extends { name: string }, TValue>({
  ...
  // Access selected rows and their data
  const selectedRows = table.getFilteredSelectedRowModel().rows;
  const selectedRowData = selectedRows.map((row) => row.original);

  // Example: Log the selected row data to the console
